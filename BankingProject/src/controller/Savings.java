...
//		pw.println(amt);
		if (operation.equals("fundtransfer")) {
			...
			if (flag) {
				...
				RequestDispatcher rd = request.getRequestDispatcher("savtransfail.jsp");
				rd.forward(request, response);			
				}
...
//			System.out.println(flag);
			if (flag) {
				...
				RequestDispatcher rd = request.getRequestDispatcher("savewithdrawsucc.jsp");
				rd.forward(request, response);
			}
			else {
				RequestDispatcher rd = request.getRequestDispatcher("savewithdrawfail.jsp");
				rd.forward(request, response);
			}
//			pw.println(operation);
//			pw.println(amount);
